...
<div class="fieldcontain ${hasErrors(bean: lampInstance, field: 'valuePwm', 'error')} required">
	<label for="valuePwm">
		<g:message code="lamp.valuePwm.label" default="Value Pwm" />
		<span class="required-indicator">*</span>
	</label>
	<g:field name="valuePwm" type="number" value="${lampInstance.valuePwm}" required=""/>
</div>
