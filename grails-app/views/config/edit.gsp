...
<html>
	...
	<body>
		<a href="#edit-config" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-config" class="content scaffold-edit" role="main">
